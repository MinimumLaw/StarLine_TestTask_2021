...
Помимо этого готов предоставить F4-Discovery и возможность 
...
в случае удачного завершения желательно сделать так
	rbuff_s *rb = (rbuff_s *)mem; для более удобного доступа к буферу
